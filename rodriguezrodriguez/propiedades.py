from PyQt6.QtNetwork import QPasswordDigestor
...
class Propiedades():
    ...
    def bajaPropiedad(self):
        ...
        elif var.ui.rbtVentapropprop.isChecked():
            novoestado = var.ui.rbtVentapropprop.text()
    ...
    def buscaProp(self):
        try:
            busqueda = [var.ui.cmbTipoprop.currentText(), var.uit.cmbMuniprop.currentText()]
